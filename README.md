...
![登录界面](docs/images/img-020.png)

**注册账号**：首次使用需要注册账号。点击"立即注册"进入注册界面。

![注册界面](docs/images/img-022.png)
...
![忘记密码](docs/images/img-024.png)

#### 3. 航班查询与预订

登录成功后进入机票预订主界面：

![预订界面](docs/images/img-026.png)
...
![添加乘客](docs/images/img-028.png)

![订票成功](docs/images/img-030.png)
...
![按起飞地搜索](docs/images/img-032.png)

![按时间搜索](docs/images/img-034.png)

#### 5. 订单管理

在"我的订单"面板可以查看已购机票和退订：

![订单管理](docs/images/img-036.png)

#### 6. 个人信息管理

在个人中心可以查看和修改个人信息：

![个人信息](docs/images/img-038.png)
...
![管理员登录](docs/images/img-040.png)

#### 2. 管理界面

管理员主界面提供航班管理、用户管理、订单管理等功能：

![管理主界面](docs/images/img-042.png)
...
![用户管理](docs/images/img-044.png)

#### 4. 订单管理

查看和管理所有订单：

![订单管理](docs/images/img-046.png)
...
![数据库ER图](docs/images/img-014.png)

- 用户与订单：一对多关系（一个用户可以有多个订单）
- 航班与订单：一对多关系（一个航班可以有多个订单）
- 乘客与订单：一对多关系（一个乘客可以有多个订单）
...
#### 登录与注册
![登录](docs/images/img-020.png)
![注册](docs/images/img-022.png)

#### 航班预订
![预订主界面](docs/images/img-026.png)
![添加乘客](docs/images/img-028.png)
![预订成功](docs/images/img-030.png)

#### 航班搜索
![搜索结果](docs/images/img-032.png)

#### 订单管理
![我的订单](docs/images/img-036.png)
